...
@media (max-width: 620px) {
  ...
  .control-panel,
  .result-panel { padding: 13px; }
  .apply-row { align-items: flex-start; flex-direction: column; }
  .apply-row :deep(.el-button) { width: 100%; }
}
</style>
