<template>
  <section class="trace-panel">
    <div class="trace-heading"><div><strong>节点追踪</strong><span>按执行顺序记录输入摘要、输出和证据</span></div><span>{{ traces.length }} 个节点</span></div>
...
@media (max-width: 620px) { .trace-heading { align-items: flex-start; padding: 12px; }.trace-list { padding: 9px 12px 12px; }.trace-title { flex-wrap: wrap; }.trace-duration { width: 100%; margin-left: 0; } }
</style>
