<template>
  <section class="data-preparation">
    <div class="data-heading"><div><p class="page-eyebrow">Data preparation</p><h3>全量 JSON 数据准备</h3><p>用字段路径和分组定义工作流需要的最小资料集。</p></div><el-button :loading="previewLoading" type="primary" @click="runPreview"><Play :size="15" />预览提取结果</el-button></div>
