...
def _list_endpoint(model: Any, db: Session, current_user: UserRead):
...
def list_model_profiles(
    ...
    db: Annotated[Session, Depends(get_request_db)] = None,
):
...
def _create_endpoint(model: Any, payload: ProfileCreate, db: Session, current_user: UserRead):
    try:
...
def _patch_endpoint(model: Any, profile_id: str, payload: ProfilePatch, db: Session, current_user: UserRead):
